<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductConfirmQueryStrings.aspx.cs" Inherits="CadenaDeConsulta_3716368.ProductConfirmQueryStrings" %>
...
<body>
    <form id="form1" runat="server">
     ...
     <asp:DropDownList ID="ddlCategory" runat="server">
         <asp:ListItem>Zapatos-Hombre</asp:ListItem>
         <asp:ListItem>Camisas-Hombre</asp:ListItem>
     ...
     <asp:TextBox ID="txtDescription" runat="server" Height="57px" TextMode="MultiLine" ></asp:TextBox>
     </p>
